...
| Stale stream detection | 180s | Raised to a 900s ceiling when left implicit (`agent.local_stream_stale_timeout`) | `providers.<id>.stale_timeout_seconds` or `HERMES_STREAM_STALE_TIMEOUT` |
