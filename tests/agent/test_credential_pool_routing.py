...
class TestFailureAttribution:
    ...
    def _make_pool(self, tmp_path, monkeypatch, entries):
        ...
        # Construct exactly the entries supplied by the test.  load_pool()
        # intentionally discovers singleton credentials (including a user's
        # Claude Code OAuth session), which made pool cardinality depend on the
        # host running pytest and invalidated these failure-attribution cases.
